...
void led_model_step(void)
{
  ...
  /* MATLABSystem: '<Root>/Digital Write13' */
  MW_digitalIO_write(led_model_DW.obj_lm.MW_DIGITALIO_HANDLE,
...
{
  {
    ...
    /* Start for MATLABSystem: '<Root>/Digital Write13' */
    led_model_DW.obj_lm.matlabCodegenIsDeleted = true;
    led_model_DW.obj_lm.isInitialized = 0;
    led_model_DW.obj_lm.matlabCodegenIsDeleted = false;
    obj_0 = &led_model_DW.obj_lm;
    led_model_DW.obj_lm.isSetupComplete = false;
    led_model_DW.obj_lm.isInitialized = 1;
    obj_0->MW_DIGITALIO_HANDLE = MW_digitalIO_open(6U, 1);
    led_model_DW.obj_lm.isSetupComplete = true;
...
void led_model_terminate(void)
{
  ...
  matlabCodegenHandle_matlabCodeg(&led_model_DW.obj_l);

  /* Terminate for MATLABSystem: '<Root>/Digital Write1' */
  matlabCodegenHandle_matlabCodeg(&led_model_DW.obj_i);

  /* Terminate for MATLABSystem: '<Root>/Digital Write10' */
  matlabCodegenHandle_matlabCodeg(&led_model_DW.obj_m);

  /* Terminate for MATLABSystem: '<Root>/Digital Write11' */
  matlabCodegenHandle_matlabCodeg(&led_model_DW.obj_n);

  /* Terminate for MATLABSystem: '<Root>/Digital Write12' */
  matlabCodegenHandle_matlabCodeg(&led_model_DW.obj_f);

  /* Terminate for MATLABSystem: '<Root>/Digital Write13' */
  matlabCodegenHandle_matlabCodeg(&led_model_DW.obj_lm);

  /* Terminate for MATLABSystem: '<Root>/Digital Write2' */
  matlabCodegenHandle_matlabCodeg(&led_model_DW.obj_nv);

  /* Terminate for MATLABSystem: '<Root>/Digital Write20' */
  matlabCodegenHandle_matlabCodeg(&led_model_DW.obj_b);

  /* Terminate for MATLABSystem: '<Root>/Digital Write3' */
  matlabCodegenHandle_matlabCodeg(&led_model_DW.obj_l0);

  /* Terminate for MATLABSystem: '<Root>/Digital Write4' */
  matlabCodegenHandle_matlabCodeg(&led_model_DW.obj_k);

  /* Terminate for MATLABSystem: '<Root>/Digital Write5' */
  matlabCodegenHandle_matlabCodeg(&led_model_DW.obj_l5);

  /* Terminate for MATLABSystem: '<Root>/Digital Write6' */
  matlabCodegenHandle_matlabCodeg(&led_model_DW.obj_e);

  /* Terminate for MATLABSystem: '<Root>/Digital Write7' */
  matlabCodegenHandle_matlabCodeg(&led_model_DW.obj_h);

  /* Terminate for MATLABSystem: '<Root>/Digital Write8' */
  matlabCodegenHandle_matlabCodeg(&led_model_DW.obj_lh);

  /* Terminate for MATLABSystem: '<Root>/Digital Write9' */
  matlabCodegenHandle_matlabCodeg(&led_model_DW.obj_o);
}
